...
router.get('/superAdmin/stores/approvals', auth.superAdmin, storeController.viewAllStoreApprovalsPending)
router.get('/superAdmin/stores/approved', auth.superAdmin, storeController.viewAllStoresApprovedActive)
