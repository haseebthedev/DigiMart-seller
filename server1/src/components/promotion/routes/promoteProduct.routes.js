...
router.post('/seller/store/product/promote/schedule', auth.seller, promoteProductController.addPromotedProduct)
...
router.post('/superAdmin/store/:id/product/promote', auth.superAdmin, promoteProductController.addPromotedProduct)
...
router.post('/superAdmin/store/:id/product/promote/schedule', auth.superAdmin, promoteProductController.addPromotedProduct)
