...
router.get('/admin/vendors/pending', auth.superAdmin , vendorController.getAllPendingVendors)
router.get('/admin/vendors/active', auth.superAdmin , vendorController.getAllActiveVendors)
router.get('/admin/vendors/blocked', auth.superAdmin , vendorController.getAllBlockedVendors)
