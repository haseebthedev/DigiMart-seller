...
const checkIfProductPromotedBefore = async(req, res, next) => {
    try{
        ...
        const isProductPresent = await PromoteProduct.find({productId})
        //if product prsent in promoted product DB
        ...
        //check if product was promoted a week ago,
            ...
            var productPromotionDate = isProductPresent[0]['promotion_date']
