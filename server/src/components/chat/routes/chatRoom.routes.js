...
router.patch('/seller/chat/:roomId/mark-read', auth.seller , chatRoom.markConversationReadByRoomId)
...
router.patch('/buyer/chat/:roomId/mark-read', auth.buyer , auth.superAdmin , chatRoom.markConversationReadByRoomId)
