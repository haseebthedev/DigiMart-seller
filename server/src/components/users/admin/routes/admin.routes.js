...
router.patch(
	"/admin/activateMyAccount",
	adminAuth,
	adminController.activateMyAccount
);
router.patch(
	"/admin/deActivateMyAccount",
	adminAuth,
...
router.patch(
	...
	adminAuth,
	adminController.editOtherAdminProfile
);
router.patch(
	"/superAdmin/blockAdmin/:id",
	adminAuth,
	adminController.blockOtherAdmin
);
router.patch(
	"/superAdmin/unBlockAdmin/:id",
	adminAuth,
	adminController.unBlockOtherAdmin
);
...
router.get(
	"/superAdmin/admin/role/:role",
	adminAuth,
	adminController.getAdminDetailsByRole
);
router.get(
	"/superAdmin/admins/number",
	adminAuth,
	adminController.getTotalNumberOfAdmins
);
